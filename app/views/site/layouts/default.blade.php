...
<html lang="en">
	<head>
		...
		<title>
			@section('title')
			{{Config::get('krubbit.name')}} - Inicio
			@show
		</title>
		...
		<div class="navbar navbar-default navbar-inverse navbar-fixed-top">
			 <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">{{Config::get('krubbit.name')}}</a>
                </div>
                <div class="collapse navbar-collapse navbar-ex1-collapse">
                    <ul class="nav navbar-nav">
						<li {{ (Request::is('/') ? ' class="active"' : '') }}><a href="{{{ URL::to('') }}}">Inicio</a></li>
		...
		<!-- Jumbotron -->
			<div class="jumbotron jumbotron-index">
		      <div class="container">
		        ...
		        <a class="btn btn-red btn-lg" role="button">Learn more »</a>
		      </div>
		    </div>
		<!-- ./Jumbotron -->
